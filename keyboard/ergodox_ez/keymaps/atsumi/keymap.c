...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_TAB,         KC_Q,         KC_W,   KC_E,   KC_R,   KC_T,   S(KC_2),
        KC_LCTL,        KC_A,         KC_S,   KC_D,   KC_F,   KC_G,
        KC_LSFT,        KC_Z,         KC_X,   KC_C,   KC_V,   KC_B,   KC_ESC,
        LT(SYMB,KC_GRV),S(KC_5),      S(KC_MINS),ALT_T(KC_GRV),KC_LGUI,
                                                      KC_LEFT,KC_RGHT,
                                                              KC_UP,
                                               KC_SPC,KC_BSPC,KC_DOWN,
        // right hand
        KC_6,        KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,          JA_HAT,
        S(KC_7),    KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,             JA_AT,
                     KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,          CTL_T(JA_CLON),
        G_S(KC_SPC), KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,          SFT_T(JA_ENUN),
                             KC_RGUI,ALT_T(JA_LBRC),JA_RBRC,JA_ENVL,       LT(SYMB, KC_NO),
             KC_HOME, KC_END,
             KC_PGUP,
             KC_PGDN, KC_ENT, LT(META, KC_SPC)
    ),
